...
function SendGet(flag) {
	...
	var name = document.getElementById("dep").value;
	...
	if (http) {
		...
		http.onreadystatechange = function f() {
			if (http.readyState == 4) {
				...
				if(ans.indexOf('Подразделение добавлено') + 1) {
					location.reload();
				} else {
					cont.innerHTML = http.responseText;
				}
...
<div id="wrap">
    ...
    <div id="menucontainer">
      ...
      <div id="menunav">
      	<ul>
      		...
      		<li><a href="#" class="current"><span>Создать подразделение</span></a></li>
      	</ul>
      </div>
    </div>
  </div>
  ...
  <p align = "center" style = "font-size:15px">Создание подразделения</p>
  <p align = "center"> Название подразделения: <input type="text" id="dep" name="dep" /></p>
  <p align = "center"><button onclick="SendGet('dep')"> Создать </button></p>
